...
<html>
  <head>
                ...
                <table >
                    <tr>
                        ...
                        <div class="header_welcomeview_right_form">
                            <input required name="_username" id="loginUsername" type="text" tabindex="1" class="form-control" placeholder="username"  value="B18756676" required>
                        </div>
                        </td>
                        <td>
                        <div class="header_welcomeview_right_form">
                    ...
                    <div class="panel with panel-primary class">
                        ...
                        <div class="panel-body">
                            <li class="list-group-item justify-content-between">
                                Puntos<span  id="profileStudentPoint" class="badge badge-default badge-pill"></span>
                            </li>
                        </div>
                    </div>
                </div>
            ...
            <fieldset>
                <div class="form-group">
                    ...
                    <div id="search_equipment" class="col-sm-9">
                        <i id="search_icon_school" onclick="selected_icon_search('search_icon_school')" title="habitacion estudio"  class="icon material-icons">school</i>
                        ...
                        <div class="col-xs-3" >
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                    <button type="button" onclick="search_rooms()"  class="btn btn-success">Buscar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="table_search_room">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr id="row_room_name_room1" onclick="display_search_room_specific('room1','residencia2027')" onmouseover="selected_row_table('row_room_name_room1')" onmouseout="out_selected_row_table('row_room_name_room1')" >
                                  <td>room1</td>
                                  <td>residencia2027</td>
                                  <td>500€</td>
                                  <td>1/1/2017</td>
                                </tr>
                                <tr id="row_room_name_room2" onclick="display_search_room_specific('room2','residencia2023')" onmouseover="selected_row_table('row_room_name_room2')"  onmouseout="out_selected_row_table('row_room_name_room2')">
                                    <td>room2</td>
                                    <td>residencia2023</td>
                                    <td>600€</td>
                                    <td>3/1/2017</td>
                                </tr>
                                <tr id="row_room_name_room3" onclick="display_search_room_specific('room3','residencia203')" onmouseover="selected_row_table('row_room_name_room3')" onmouseout="out_selected_row_table('row_room_name_room3')" >
                                    <td>room3</td>
                                    <td>residencia203</td>
                                    <td>400€</td>
                                    <td>1/3/2017</td>
                                </tr>
                                <tr id="row_room_name_room4" onclick="display_search_room_specific('room4','residencia1')" onmouseover="selected_row_table('row_room_name_room4')" onmouseout="out_selected_row_table('row_room_name_room4')" >
                                    <td>room4</td>
                                    <td>residencia1</td>
                                    <td>5100€</td>
                                    <td>2/1/2017</td>
                ...
                <div class="col-sm-4">
                    <div class="panel-group">
                        <div class="panel with panel-primary class">
                            ...
                            <div id="search_room_table_map"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel with panel-primary class">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="right_room">
                                    <div id="search_room_specific_slider_img">
                                        <div id="search_room_specific_slidesContainer_img">
                                        ...
                                        </div> <!-- /search_room_specific_slidesContainer-->
                                    </div> <!-- /search_room_specific_slider -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="panel-group">
                        <div class="panel with panel-primary class">
                            ...
                            <div class="panel-body">
                                <label>Nombre:   </label><label id="search_room_specific_CollegeStudentName"></label></br>
                                <label>Contacto:   </label><label id="search_room_specific_CollegeStudentContact"></label></br>
                                <label>Url:   </label><label id="search_room_specific_CollegeStudentWeb"></label></br>
                                <label>Equipamiento:   </label></br>
                            </div>
                            <div id="search_room_specific_map"></div>
                        </div>
                    </div>
                        ...
                        <div class="panel with panel-primary class">
                            ...
                            <div class="panel-body">
                                ...
                                <ul id="earch_room_specific_ul" class="list-group">
                                    ...
                                    <li class="list-group-item justify-content-between">
                                        Puntos<span class="badge badge-default badge-pill">2</span>
                                    </li>
                                    <li class="list-group-item justify-content-between">
                                        Puntos<span class="badge badge-default badge-pill">1</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script id="collegeview" type=”text/view”>
    <nav class="nav nav-pills nav-justified">
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                <li onclick="page('/college_list_rooms')"> <a> <label>Lista habitaciones</label> </a> </li>
                <li onclick="page('/connection')"> <a> <label>Log out</label> </a> </li>
            </ul>
        </div>
    </nav> <!-- end nav -->
    <div id="college_list_rooms">
        <div id="college_table_list_rooms">
            <div class="college_table_list_rooms">
                <table  class="table table-striped">
                    <thead>
                    <tr>
                      <th>nombre</th>
                      <th>inicio academico</th>
                      <th>fin academico</th>
                      <th>inicio puja</th>
                      <th>fin puja</th>
                      <th>tamaño</th>
                      <th>planta</th>
                      <th>cliente</th>
                      <th><i  title="television" class="icon fa fa-television" aria-hidden="true"></i></th>
                      <th><i title="baño" class="icon fa fa-bath" aria-hidden="true"></i></th>
                      <th><img title="escritorio" class="icon_img" src="data:image/svg+xml;utf8;base64," /></th><!--desk -->
                      <th><img title="armario"  class="icon_img" src="data:image/svg+xml;utf8;base64," /></th><!-- wardrove -->
                    </tr>
                    </thead>
                    <tbody  id="college_element_table_list_rooms">
                    </tbody>
                </table>
            </div>
        </div>
    </div> <!-- end home -->
    <div class="error_footer" id="showErrorMessageCoollegePage" style="display:none;">
        <strong>
            <center>
                <p id="errorMessageCollegePage"> Error </p>
            </center>
        </strong>
    </div> <!-- end showErrorMessageStudentPage -->
    </script>
