...
<html>
  <head>
    ...
    <div id="Room">
        <button type="button" class="button_margin btn btn-primary">Aceptar y firmar contrato</button>
        <button type="button" class="button_margin btn btn-success">Descargar contrato</button>
        <button type="button" class="button_margin btn btn-warning">Rechazar habitacion</button>
        <div class="row">
                ...
                <div class="panel-group">
                    <div class="panel with panel-primary class">
                        ...
                        <div class="panel-body">
                            ...
                            <i title="habitacion estudio"  class=" material-icons">school</i>
                            <i title="gym" class="material-icons">fitness_center</i>
                            <i title="cantina"class="material-icons">restaurant_menu</i>
                            <i title="wifi" class="fa fa-wifi" aria-hidden="true"></i>
                            <i title="lavanderia" class="material-icons">local_laundry_service</i>
                            <i title="calefaccion" class="fa fa-thermometer-full" aria-hidden="true"></i> <!-- heating -->
                            ...
                            <i title="television" class="fa fa-television" aria-hidden="true"></i>
                            <i title="baño" class="fa fa-bath" aria-hidden="true"></i>
        ...
        <form class="panel-footer" action="javascript:void(0);" method="post" enctype="multipart/form-data" >
            <div class="input-group">
                ...
                <span class="fileUpload input-group-btn">
                    <button class="btn btn-warning btn-sm"><i class="glyphglyphicon-paperclip"></i> </button>
